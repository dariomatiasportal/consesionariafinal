...
class GanttDataItem extends DataItem{
    ...
    */
    function to_xml(){
        ...
        $str.="<orden><![CDATA[".$this->data[$this->config->text[3]["name"]]."]]></orden>";
        $str.="<cliente><![CDATA[".$this->data[$this->config->text[4]["name"]]."]]></cliente>";
        for ($i=5 $i<sizeof($this->config->text); $i++){
...
class GanttDataProcessor extends DataProcessor{
    function name_data($data){
        ...
        if ($data=="text")
            return $this->config->text[3]["name"];
